...
public class InverseModulaire extends javax.swing.JFrame {

    /**
     * Creates new form mainJfram
     */
    public InverseModulaire() {
        initComponents();
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 class euclide_Worker extends SwingWorker< EuclideEtenduTRIPLE ,Void > {
    ...
    @Override
       public EuclideEtenduTRIPLE doInBackground() throws InterruptedException, IOException { // type 1
return EuclideEtendu(a,b);
       ...
       protected void done() {
            ...
            onWork=false;
                 ...
                 try {   
                     if(!(get().getPgcd().equals(BigInteger.ONE)))
                     { jTextArea1.setText("ce nombre n'a pas d'inverse dans ce modulo! "
                                 + "\n a et m ne sont pas premiers\n pgcd = "+get().getPgcd().toString());
                     jTextArea2.setText("l'inverse n'existe pas");
                     }else{
                    // int bitsNum=get().getX().mod(b).bitLength() ;
                    BigInteger inv= get().getX().mod(b);
                    int bitsNum = inv.bitLength();
                         if(bitsNum<100000){
                     jTextArea2.setText(inv.toString());
                       jLabel28.setVisible(true);
                       
                          jTextArea1.setText("l'inverse de a mod m exist si pgcd(a,m)=1, ici c'est le cas\n"
                                  + "si (d,x,y) = EuclideEtendu(a,m) alors x mod m est l'inverse de a (mod m)\n"
                                  + "x = " +get().getX().toString()+" et l'inverse de x mod m = " + inv.toString()
                                  );
                   ...
                   /////////////////////////////////////////////////////////////////////////////////////////////
                    ...
                    workerF.execute();
                    FileWriter wf = new FileWriter("outInvMod.txt");
                    
                    wf.write(inv.toString());
             ...
             //////////////////////////////////////////////////////////////////////////////////////                                      
                     ...
                     Logger.getLogger(EuclideEtendue.class.getName()).log(Level.SEVERE, null, ex);
                 }
  ...
  protected void process(final List<String> chunks) { // hee type2
   jTextArea1.setText("");
    ...
    private void initComponents() {
        ...
        jLabel18.setText("Inverse modulaire");
        ...
        jTextField3.setBounds(80, 100, 90, 20);
        ...
        jLabel21.setText("mod");
        jPanel11.add(jLabel21);
        jLabel21.setBounds(200, 100, 40, 20);
        ...
        jLabel31.setText("INV (");
        jPanel11.add(jLabel31);
        jLabel31.setBounds(30, 90, 50, 40);

        jLabel32.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel32.setForeground(new java.awt.Color(94, 82, 146));
        jLabel32.setText(" )");
        jPanel11.add(jLabel32);
        jLabel32.setBounds(170, 90, 20, 40);

        jLabel23.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel23.setForeground(new java.awt.Color(94, 82, 146));
        jLabel23.setText("=");
        jPanel11.add(jLabel23);
        jLabel23.setBounds(310, 150, 13, 14);
...
if(jTextField1.getText().equals("m"))
jTextField1.setText("");
// TODO add your handling code here:
...
File file = new File("outEuclideEtendue.txt");
