...
public class EuclideEtendue extends javax.swing.JFrame {

    /**
     * Creates new form mainJfram
     */
    public EuclideEtendue() {
        initComponents();
...
return EuclideEtendu(a,b);
       ...
       protected void done() {
            ...
            onWork=false;
                 ...
                 try {   
                     int bitsNum = get().getPgcd().bitLength()+get().getX().bitLength()+get().getY().bitLength();
                     if(bitsNum<100000){
                     jTextArea1.setText("PGCD(a,b) = "+get().getPgcd().toString()+
                             "\n x = "+get().getX().toString()+
                             "\n y = "+get().getY().toString()+
                     "\n a.x+b.y=pgcd(a,b)");
                       jLabel28.setVisible(true);
                       
                          jTextArea2.setText("(d,x,y) = ( "+get().getPgcd().toString()+" , "
                            +get().getX().toString()+ " , "+get().getY().toString()+
                     " )");
                   ...
                   /////////////////////////////////////////////////////////////////////////////////////////////
                    ...
                    workerF.execute();
                    FileWriter wf = new FileWriter("outEuclideEtendue.txt");
                    
                    wf.write("PGCD(a,b) = "+get().getPgcd().toString()+
                             "\n x = "+get().getX().toString()+
                             "\n y = "+get().getY().toString()+
                     "\n a.x+b.y=pgcd(a,b)");
  ...
  protected void process(final List<String> chunks) { // hee type2
   jTextArea1.setText("");
    ...
    private void initComponents() {
        ...
        jLabel18.setText("Euclide Etendu");
