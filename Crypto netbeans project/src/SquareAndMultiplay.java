...
public class SquareAndMultiplay extends javax.swing.JFrame {

    /**
     * Creates new form mainJfram
     */
    public SquareAndMultiplay() {
        initComponents();
...
/////////////////////////////////////////////////////////////////////////
	 ...
	 class powSM_Worker extends SwingWorker< BigInteger ,Void > {
  
             BigInteger b; //base
             BigInteger p; //power
             
    public powSM_Worker (BigInteger B, BigInteger P) 
    {
     b=B;
     p=P;
    }
...
return aPOWb;
      ...
      @Override
       public void done() { // once the thread finish this function start and in the events dispatch thread
         try {
        jTextField4.setText(get()+ " chfrs dcm");
  ...
  protected void process(final List<String> chunks) { // hee type2
   jTextArea1.setText("");
    ...
    private void initComponents() {
        ...
        jLabel18.setText(" square and multiply (etude)");
        ...
        jTextField3.setBounds(53, 104, 220, 20);
        ...
        jLabel25.setText("cliquer pour voir");
        jPanel21.add(jLabel25);
        jLabel25.setBounds(305, 85, 99, 17);
        jLabel25.setVisible(false);

        jLabel26.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel26.setForeground(new java.awt.Color(162, 87, 179));
        jLabel26.setText("Les etapes ");
        jPanel21.add(jLabel26);
        jLabel26.setBounds(314, 107, 120, 17);
        ...
        jLabel22.setBounds(380, 80, 100, 20);
        jLabel22.setVisible(false);
        ...
        jTextArea2.setForeground(new java.awt.Color(110, 114, 145));
        ...
        jLabel30.setBounds(480, 80, 50, 20);
        jLabel30.setVisible(false);
        ...
        jTextField4.setBounds(370, 200, 160, 20);
...
powSM_Worker workerPow; // my worker reference
...
worker.execute();
 ...
 workerPow = new powSM_Worker(new BigInteger(jTextField3.getText()), new BigInteger(jTextField1.getText()));
workerPow.execute();
