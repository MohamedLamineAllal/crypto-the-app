...
public class chifrVignere extends javax.swing.JFrame {
...
public class AlphaContainer extends JComponent
{
    ...
    private void initComponents() {
        ...
        jLabel10.setText("          Chiffrement de Playfaire     ");
        ...
        jLabel22.setText("Chiffrement de Vignère");
...
jTextField1.setText(jTextField1.getText().toUpperCase());          // TODO add your handling code here:
...
jTextArea2.setText("");
 ...
 mainWorker = new SwingWorker<String, Void>() {
        ...
        onWork = true;
        timer1 = new Timing();
        String result = chiffrementVignere(jTextArea1.getText(), cle);
...
jTextField2.setText(jTextField1.getText().toUpperCase());         // TODO add your handling code here:
...
jTextArea3.setText("");
 ...
 mainWorker2 = new SwingWorker<String, Void>() {
        ...
        onWork2 = true;
        timer2 = new Timing();
        String result = dechiffrementVignere(jTextArea4.getText(), cle);  
