...
public class SquareAndMultiplayEfficace extends javax.swing.JFrame {

    /**
     * Creates new form mainJfram
     */
    public SquareAndMultiplayEfficace() {
        initComponents();
...
return aPOWb;
      ...
      @Override
       public void done() { // once the thread finish this function start and in the events dispatch thread
         try {
        jTextArea2.append(" (il contient "+get()+ " chiffres dicimaux). Il est de "+bitsNum+" bits");
  ...
  protected void process(final List<String> chunks) { // hee type2
   jTextArea1.setText("");
    ...
    private void initComponents() {
        ...
        jLabel18.setText(" square and multiply");
