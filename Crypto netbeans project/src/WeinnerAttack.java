...
public class WeinnerAttack extends javax.swing.JFrame {

    /**
     * Creates new form mainJfram
     */
    public WeinnerAttack() {
        initComponents();
...
public BigInteger getPrivateExpoWeinnerAttack(BigInteger N, BigInteger e){
  ArrayList<BigInteger> frac = getContinusFractionRational(e, N);
  BigInteger d= BigInteger.ONE.negate();
  BigInteger M = randomBI(N.subtract(BigInteger.ONE));
  BigInteger C = M.modPow(e, N);
  for(int i =0; i<frac.size(); i++){
    d = ConvergenteQn(i, frac);
    if(C.modPow(d, N).equals(M))
        return d;
  }
  return d;
}
    ...
    private void initComponents() {
        ...
        jTextField8.setBounds(140, 140, 120, 20);
        ...
        jTextField6.setBackground(new java.awt.Color(40, 36, 52));
        jTextField6.setForeground(new java.awt.Color(89, 85, 113));
        jTextField6.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        jTextField6.setBorder(javax.swing.BorderFactory.createMatteBorder(1, 1, 1, 1, new java.awt.Color(41, 54, 66)));
        jTextField6.setDragEnabled(true);
        jTextField6.setFocusable(false);
        jTextField6.setMargin(new java.awt.Insets(2, 7, 2, 7));
        ...
        jPanel31.add(jTextField6);
        jTextField6.setBounds(420, 290, 120, 20);

        jLabel29.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel29.setForeground(new java.awt.Color(159, 68, 68));
        jLabel29.setText("d");
        jPanel31.add(jLabel29);
        jLabel29.setBounds(470, 250, 50, 20);
        jLabel24.setVisible(false);

        jLabel30.setFont(new java.awt.Font("Tahoma", 0, 16)); // NOI18N
        jLabel30.setForeground(new java.awt.Color(159, 68, 68));
        jLabel30.setText("=");
        jPanel31.add(jLabel30);
        jLabel30.setBounds(470, 270, 50, 20);
        jLabel24.setVisible(false);
        ...
        jLabel28.setBounds(290, 170, 30, 30);
        ...
        jLabel20.setText("Trouver d (exp privé)");
        ...
        jLabel20.setBounds(110, 180, 170, 20);
        ...
        jLabel42.setBounds(140, 120, 140, 17);
        ...
        jLabel26.setBounds(470, 350, 50, 20);
        jLabel24.setVisible(false);
        ...
        jLabel27.setBounds(470, 330, 50, 20);
        jLabel24.setVisible(false);
...
if(jTextField3.getText().equals("")||jTextField8.getText().equals(""))
...
SwingWorker<BigInteger,Void> worker = new  SwingWorker<BigInteger,Void> (){
 @Override
     ...
     return getPrivateExpoWeinnerAttack(N, e);
       }
       
      @Override
       public void done() { try {
           System.out.println("done");
      timer1on = false; 
      onWork=false;// once the thread finish this function start and in the events dispatch thread
    System.out.println("pre get");
      BigInteger d = get();
      System.out.println("after get d = "+d.toString());
       BigInteger    p = getFactorFromExposant(N, e, d);
           System.out.println("after expo");
    BigInteger q= N.divide(p);
timer1.updateDuration();

    
    
            jTextArea1.setText("L'exposant privé d = \n"+d.toString()+"\n\n "+" N=p.q tel que:\n"+
            "p = "+ p.toString() + "\n q = "+q.toString());
    ...
    jTextField12.setText(q.toString());
         ...
         Logger.getLogger(WeinnerAttack.class.getName()).log(Level.SEVERE, null, ex);
...
timer1=new Timing(); // start timer
                ...
                = new SwingWorker<Void, String>() {
                    ...
                    public void done() {
                        ...
                        jTextField2.setText(timer1.strTimeUnivMS());
                    }
