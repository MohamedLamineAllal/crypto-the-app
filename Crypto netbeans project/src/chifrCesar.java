...
public class chifrCesar extends javax.swing.JFrame {
...
public class AlphaContainer extends JComponent
{
    ...
    private void initComponents() {
        ...
        jLabel6.setText("     Chiffrement Affine");
        ...
        jLabel22.setText("Chiffrement de César");
...
boolean timer1on ; // timer flag on/of
  boolean onWork = false; // flage explaining that the worker stay work (on work the action can't applied twice )
   ...
   chifrCesar thisFram = this;
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
 if(!onWork){
	 int cle = Integer.parseInt(jTextField1.getText());
...
jTextArea2.setText("");
 ...
 mainWorker = new SwingWorker<String, Void>() {
        ...
        onWork = true;
        timer1 = new Timing();
        String result = chiffrementCesar(jTextArea1.getText(), cle);
...
if(!onWork2){
	 int cle = Integer.parseInt(jTextField2.getText());
...
jTextArea3.setText("");
 ...
 mainWorker2 = new SwingWorker<String, Void>() {
        ...
        onWork2 = true;
        timer2 = new Timing();
        String result = dechiffrementCesar(jTextArea4.getText(), cle);  
