...
public class FractionContinnue extends javax.swing.JFrame {

    /**
     * Creates new form mainJfram
     */
    public FractionContinnue() {
        initComponents();
...
public ArrayList<BigInteger> getContinusFractionRational(BigInteger a, BigInteger b){
  ...
  int i = 0;
    ArrayList<BigInteger> frac = new ArrayList<BigInteger>();
    frac.add(q);
...
public String showFrac(ArrayList<BigInteger> frac){
    String result = "[ ";
    int i = 0;
    for(; i < frac.size()-1; i++ ){
        result = result + frac.get(i)+ " , ";
    }
...
public BigInteger ConvergentePn(int n , ArrayList<BigInteger> frac){
    if(n == -2) 
        return BigInteger.ZERO;
    else if(n==-1)
        return BigInteger.ONE;
    else 
        return frac.get(n).multiply(ConvergentePn(n-1, frac)).add(ConvergentePn(n-2, frac));    
}

public BigInteger ConvergenteQn(int n , ArrayList<BigInteger> frac){
    if(n == -2) 
        return BigInteger.ONE;
    else if(n==-1)
        return BigInteger.ZERO;
    else 
        return frac.get(n).multiply(ConvergenteQn(n-1, frac)).add(ConvergenteQn(n-2, frac));    
}
    ...
    private void initComponents() {
        ...
        jLabel43.setBounds(410, 330, 160, 17);
        ...
        jTextField11.setBounds(420, 210, 100, 20);

        jPanel29.setBackground(new java.awt.Color(48, 40, 63));

        jLabel36.setForeground(new java.awt.Color(89, 84, 108));
        jLabel36.setText("Fraction continue");

        jLabel37.setForeground(new java.awt.Color(182, 88, 88));
        jLabel37.setText("et convergentes");
        ...
        jTextField8.setBounds(120, 140, 100, 20);
        ...
        jTextField3.setBounds(120, 100, 100, 20);
        ...
        jLabel28.setBounds(270, 180, 30, 30);
        ...
        jLabel20.setText("Calculer la fraction continue");
        ...
        jLabel20.setBounds(90, 180, 170, 20);

        jLabel24.setForeground(new java.awt.Color(150, 49, 49));
        jLabel24.setText("entrer les donné d'abord!");
        jPanel31.add(jLabel24);
        jLabel24.setBounds(240, 120, 150, 20);
        jLabel24.setVisible(false);

        jLabel27.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jLabel27.setForeground(new java.awt.Color(114, 87, 135));
        jLabel27.setText("q_n");
        jPanel31.add(jLabel27);
        jLabel27.setBounds(440, 280, 40, 20);

        jLabel31.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel31.setForeground(new java.awt.Color(94, 82, 146));
        jLabel31.setText("Calcule de la fraction continue");
        ...
        jLabel21.setBounds(440, 240, 60, 20);

        jLabel29.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel29.setForeground(new java.awt.Color(128, 86, 159));
        jLabel29.setText("=");
        jPanel31.add(jLabel29);
        jLabel29.setBounds(480, 270, 20, 20);

        jLabel30.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jLabel30.setForeground(new java.awt.Color(114, 87, 135));
        jLabel30.setText("------");
        jPanel31.add(jLabel30);
        jLabel30.setBounds(440, 270, 40, 20);

        jLabel32.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jLabel32.setForeground(new java.awt.Color(114, 87, 135));
        jLabel32.setText("p_n");
        jPanel31.add(jLabel32);
        jLabel32.setBounds(440, 260, 40, 20);

        jLabel44.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel44.setForeground(new java.awt.Color(128, 86, 159));
        jLabel44.setText("<html>Entrer n pour calculer<br> la n eme convergente </html>");
        jPanel31.add(jLabel44);
        jLabel44.setBounds(400, 140, 150, 90);
        ...
        jLabel23.setText("!! Selon la fraction continue !!");
        jPanel31.add(jLabel23);
        jLabel23.setBounds(410, 400, 160, 20);
...
jLabel22.setText("");
jLabel23.setVisible(false);
frac = getContinusFractionRational(new BigInteger(jTextField3.getText()) /*a*/,new BigInteger(jTextField8.getText())/*b*/);
jTextArea1.setText(showFrac(frac));
    ...
    private void jTextField1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField1KeyPressed
        ...
        if(length>1){
            char c =jTextField8.getText().charAt(length-1);
            if(c<48 || c>57)  // equivalent to if(!(c=='0' || c=='1'|| c=='2'|| c=='3'|| c=='4'|| c=='5'|| c=='6'|| c=='7'|| c=='8'|| c=='9'))
            jTextField1.setText(jTextField8.getText().substring(0, length-1));}
        else if(length==1){
            char c =jTextField8.getText().charAt(0);
            if((c<48 || c>57)&&c!='-') jTextField8.setText("");
        }
    ...
    private void jTextField1FocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jTextField1FocusGained
        ...
        if(jTextField8.getText().equals("b"))
        jTextField8.setText("");
        // TODO add your handling code here:
 ...
 jTextField11.setBackground(new java.awt.Color(51, 46, 66));
        ...
        if(jTextField11.getText().equals("n")){
jTextField11.setText("");
 ...
 jTextField11.setBackground(new java.awt.Color(40, 36, 52));
        ...
        jTextField11.setText("n");        // TODO add your handling code here:
   ...
   int n = Integer.valueOf(jTextField11.getText());
   int fracSize = frac.size();
if(fracSize> n){
jTextField5.setText( ConvergentePn(n,frac ).toString());
jTextField12.setText( ConvergenteQn(n,frac ).toString());
jLabel22.setText("");
jLabel23.setVisible(false);
}
else{
jLabel22.setText("Attention: n ds [0,"+(fracSize-1)+"]");
